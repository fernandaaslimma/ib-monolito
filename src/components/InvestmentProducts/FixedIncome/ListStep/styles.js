...
export const ConatinerListWrapper = styled.div`
  margin-bottom: ${rem(64)};
`;

export const EmptyWrapper = styled.div`
  padding: ${rem(40)} ${rem(16)} ${rem(79)};
  display: flex;
...
export const EmptyWrapperMessage = styled.span`
  font-family: Lato;
  font-style: normal;
  font-weight: bold;

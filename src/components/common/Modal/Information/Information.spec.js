...
import Information, { renderDescription } from "./Information";
...
describe("Default component", () => {
  it("should match snapshot with a closed modal", () => {
    expect(shallow(<Information />)).toMatchSnapshot();
  });
  ...
  it("should match snapshot with an open modal", () => {
    ...
    expect(shallow(<Information {...props} />)).toMatchSnapshot();
  });

...
const { bbmUrl } = require("./utils/constants");
const ZALENIUM_HOST = process.env.HOST || "localhost";
...
const { browserCommands } = require("./utils/custom-commands");
...
exports.config = {
  ...
  baseUrl: bbmUrl, //or 'http://localhost'
  //
  ...
  cucumberOpts: {
    ...
    tagExpression: "@Implemented and not @Skip and not @NotImplemented and not @Manual",
  ...
  onComplete: function (exitCode, config, capabilities, results) {
    generate({
      ...
      reportName: "Relatório de excução de testes - E2E - Regressão",
      screenshotPath: "./reportsQa/screenshots/",
      displayDuration: true,
      saveCollectedJSON: true,
      jsonDir: ".tmp/json/",
      reportPath: "./reports/tfs/regression",

  ...
  ...config,
    ...{
      ...
      cucumberOpts: {
        ...
        tagExpression: "@SmokeTest and not @Skip and not @NotImplemented and not @Manual",
      ...
      onComplete: function (exitCode, config, capabilities, results) {
        generate({
          ...
          reportName: "Relatório de excução de testes - E2E - Smoke Testing",
          screenshotPath: "./reportsQa/screenshots/",
          displayDuration: true,
          saveCollectedJSON: true,
          jsonDir: ".tmp/json/",
          reportPath: "./reports/tfs/smoke_test",
